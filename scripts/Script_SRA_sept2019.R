...
#Create subset
DD <- df[,c("ID","Gender_Girl", "school", "Food_Security_1", "Food_Security_2", "Food_Security_3", "negmean", "posmean", "PANAS_Ashamed", "PANAS_Embarrassed", "FI")]
View(DD)
